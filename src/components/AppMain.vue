    ...
    <div class="container mt-5">
        ...
        <div class="row">
            <div v-for="project in projectArray" class="col">
                <div class="card mb-3" style="width: 18rem;">
                    <img v-if="project.image_path !== null" :src="`${imgPath}/${project.image_path}`"
        ...
        <div class="mt-5 d-flex justify-content-center">
            <nav aria-label="Page navigation example">
                <ul class="pagination">
                    <li @click.prevent="showPrev(--curPage)" :disabled="curPage === 1" class="page-item"><a
                            class="page-link" href="#">Previous</a></li>

                    <li v-for="page in lastPage" @click.prevent="changePage(page)" class="page-item"
                        :class="curPage === page ? 'active' : ''"><a class="page-link" href="#">{{ page }}</a></li>

                    <li @click.prevent="showNext(++curPage)" :disabled="curPage === lastPage" class="page-item"><a
